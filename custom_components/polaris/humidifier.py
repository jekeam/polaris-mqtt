...
from .const import (
    ...
    POLARIS_HUMIDDIFIER_3C_MODE_TYPE,
    ...
    HUMIDDIFIER_3C_AVAILABLE_MODES,
...
class PolarisHumidifier(PolarisBaseEntity, HumidifierEntity):
    ...
    def __init__(
        ...
        elif device_type in POLARIS_HUMIDDIFIER_3C_MODE_TYPE:
            self.my_operation_list = HUMIDDIFIER_3C_AVAILABLE_MODES
